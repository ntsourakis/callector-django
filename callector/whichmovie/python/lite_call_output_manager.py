...
import whichmovie.python.lite_call_english as english
import whichmovie.python.lite_call_french as french
import whichmovie.python.lite_call_german as german
