...
def german_strings():
    return {# Normal responses
            ...
            'Repeat. {text}': 'Wiederholen. {text} <audio src="SYSTEM_AUDIO_DIR/end_of_turn.mp3"/>',
            ...
            'Help: is it {text}. {prompt}': 'Hilfe: ist es {text}? <audio src="SYSTEM_AUDIO_DIR/end_of_turn.mp3"/>',
            ...
            'At end of lesson': 'Die Lektion ist beendet. <audio src="SYSTEM_AUDIO_DIR/end_of_turn.mp3"/>',
            ...
            'No more lessons': 'Spiel Ende.',
            'Something went wrong': 'Etwas ist schief gelaufen <audio src="SYSTEM_AUDIO_DIR/end_of_turn.mp3"/>',
            # Names of cards
            ( 'Welcome', ): 'Willkommen',
            ( 'Respond', ): 'Antworten',
            # High score phrases
            ( 'You have the Nth highest score', 1): 'Sie haben die höchste Punktzahl.',
            ( 'You have the Nth highest score', 2): 'Sie haben die zweithöchste Punktzahl.',
            ( 'You have the Nth highest score', 3): 'Sie haben die dritthöchste Punktzahl.',
            ( 'You have the Nth highest score', 4): 'Sie haben die vierthöchste Punktzahl.',
            ( 'You have the Nth highest score', 5): 'Sie haben die fünfthöchste Punktzahl.',
            ( 'You have the Nth highest score', 6): 'Sie haben die sechsthöchste Punktzahl.',
            ( 'You have the Nth highest score', 7): 'Sie haben die siebthöchste Punktzahl.',
            ( 'You have the Nth highest score', 8): 'Sie haben die achthöchste Punktzahl.',
            ( 'You have the Nth highest score', 9): 'Sie haben die neunthöchste Punktzahl.',
            ( 'You have the Nth highest score', 10): 'Sie haben die zehnthöchste Punktzahl.'
            }
