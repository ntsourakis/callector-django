...
import numbergame.python.lite_call_english as english
import numbergame.python.lite_call_french as french
import numbergame.python.lite_call_german as german
